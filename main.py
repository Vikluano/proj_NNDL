...
def run(datapath):
    ...
    list_err_train, list_err_val, list_acc_train, list_acc_test, combinations = n.crossValidationKFold(X=train_X, 
                                                                        ...
                                                                        k=5,
                                                                        n_epoch=20)
    # n.myPlot3(list_err_train, list_err_val, combinations)
    # n.myPlot3(list_acc_train, list_acc_test, combinations, f=1)
    n.myPlot2(list_err_train, list_err_val, list_acc_train, list_acc_test, combinations)

if __name__ == '__main__':
    # train_X, test_X, train_lab, test_lab = d.loadDataset(d.data_path_1)
